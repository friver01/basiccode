<html>
	...
	<form id= 'options' action="http://titan.dcs.bbk.ac.uk/~friver01/collaborationoutcome11.php" method="get">
	...
	<?php
		if (isset ($_GET["venue"])) {
			...
			foreach ($sourceselected as $value1){
					$xmlDoc = new DOMDocument;
					$xmlDoc->load('http://titan.dcs.bbk.ac.uk/~friver01/'.$value1);
	...
	#	included in the array $sourceselected and the pid identifier included as a value
		...
		function retrievecollaboration1($value,$sourceselected,$venue){
